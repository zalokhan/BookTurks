    ...
    function (e) {
        var t = function (t, a) {
            ...
            var b = "xml" === o.dataType ? o.messages.viewXML : o.messages.viewJSON,
                ...
                submitbutton = c.markup("button", o.messages.submit, {
                    className: "btn btn-success " + o.prefix + "submit",
                    id: n + "-submit",
                    type: "submit"
                }),
                w = c.markup("div", [k, x, submitbutton], {
            ...
            var M = function (e) {
                ...
                _ = function (e, t) {
                    ...
                    if ("placeholder" !== e || a.inArray(t.type) || m.push(!0), "name" === e && l.inArray(t.type) && m.push(!0), "maxlength" === e && r.inArray(t.type) && m.push(!0), !m.some(function (e) {
                        ...
                        if (e == "className" || e == "name") {
                            var f = "";
                            p += "label" === e && s.inArray(t.type) ? '<textarea name="' + e + '" placeholder="' + u + '" class="fld-' + e + ' form-control" id="' + e + "-" + d + '">' + n + "</textarea>" : '<input type="hidden" value="' + n + '" name="' + e + '" placeholder="' + u + '" class="fld-' + e + ' form-control" id="' + e + "-" + d + '">', p = '<div class="form-group ' + e + '-wrap">' + f + " " + p + "</div>"
                        }
                        else {
                            if (e == 'label') {
                                i = 'Question'
